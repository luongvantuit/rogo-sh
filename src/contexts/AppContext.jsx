                ...
                if (initial) {
                    ...
                    return (
                        <div className="flex flex-col justify-center items-center w-screen h-screen">
                            ...
                            <svg role="status" className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-300 fill-blue-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
