          ...
          return (
            <div className="flex flex-col justify-center items-center w-screen h-screen">
              <img
                ...
                className="w-[120px] h-[120px] p-[16px] transition"
              />
              <p className="tracking-[1px] font-bold text-[32px] text-gray-400 my-[16px]">
                Rogo Solutions
              </p>
              <svg
                role="status"
                className="w-12 h-12 mr-2 text-gray-200 animate-spin dark:text-gray-300 fill-blue-400"
                viewBox="0 0 100 101"
                fill="none"
